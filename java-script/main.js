...
// import {generertags} from "./Fishoye/construction-generer-tags";
import { generertags,genernermenu } from "./construction-generer-tags.js";
...
function constructionOfHeader() {
  ...
  //  declarer une var = nomer la function(les parmetre)
  //  var resulttag = generertags(FishEyeData.photographers)
  // console.log(resulttag) (formules pour appeler la function)
  ...
  function generermain(main) {
    ...
    for (let i = 0; i < main.length; i++) {
      ...
      mainElement.setAttribute('href', `page-detail.html?parametre=${article.id}`) 
      // Création des bales 
